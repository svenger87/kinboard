...
Or set `KINBOARD_URL` in the user environment so the same script works across redeployments. See [[Presence-Sensor]] for full setup details.
...
- [[Self-hosting]] — the Kinboard host the kiosk points at
