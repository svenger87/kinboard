...
Stonks shipped in v1.0.19 as the fourth bundled [SurfacePlugin](Plugin-Development), alongside Vehicles, Energy, and Cameras.
...
- [[Plugin-Development]] — the `SurfacePlugin` contract Stonks implements
