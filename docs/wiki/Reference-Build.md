...
- **Sensor** — USB-A → USB-UART → LD2410 leads (only if you've added the presence sensor; see [Presence-Sensor](Presence-Sensor))
...
- [Kiosk-Windows-11-Mele-4C](Kiosk-Windows-11-Mele-4C) — the software setup that runs on this hardware
- [Presence-Sensor](Presence-Sensor) — LD2410 wiring + script
