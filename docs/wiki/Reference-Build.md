...
This page documents the **maintainer's actual fielded build**: the components, vendor links, photos, and basic spec sheet for each piece. Familyboard runs on any HDMI display + any small PC, but if you want a known-good combination this is one.
...
- 1920×1200 isn't 1920×1080. Familyboard's CSS uses a 16:9-ish dashboard layout but renders fine at 16:10 — the slightly extra vertical space is welcome.
