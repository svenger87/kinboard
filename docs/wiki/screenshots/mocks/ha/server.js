...
// Kinboard surfaces touching HA render with believable state.
//
// Only the routes Kinboard actually hits are implemented. We don't
...
const server = http.createServer(async (req, res) => {
  ...
  // /api/services — list of available services (Kinboard probes this)
