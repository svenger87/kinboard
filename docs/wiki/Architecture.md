...
- **No telemetry, no analytics, no error reporting.** Self-hosted means self-hosted. Your installation contacts GitHub only to check for a newer release, and that check can be turned off.
