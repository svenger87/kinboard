...
Familyboard ships **English (en)** and **German (de)** out of the box. The whole UI is translated — 2200+ strings, parity-checked in CI.
...
- [[Architecture]] — where the i18n bundles live
- See [`webapp/messages/en.json`](https://github.com/svenger87/familyboard/blob/main/webapp/messages/en.json) for the source of truth
