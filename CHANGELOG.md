...
- Weather details (day names, times in the forecast dialog) now follow the app language everywhere, and the weather settings Save button disables again when you revert your edits.
