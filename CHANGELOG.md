...
### Changed
- Brand assets refreshed: new Kinboard logo applied to PWA icons (main + shopping), favicon, and added under `assets/logos/` (icon + maskable, 192/512). Wiki and README updated to reference the new files.
